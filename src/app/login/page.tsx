      ...
      <div className="w-full max-w-sm mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-400">
            Masuk ke panel manajemen organisasi
          </p>
        </div>

        {registered === "1" && (
          <div className="mb-6 p-3 rounded-lg bg-green-500/10 border border-green-500/20 flex items-start gap-2 text-sm text-green-400">
        ...
        {(error === "OAuthSignin" || error === "OAuthCallback" || error === "OAuthCreateAccount") && (
          <div className="mb-6 p-3 rounded-lg bg-red-500/10 border border-red-500/20 flex items-start gap-2 text-sm text-red-400">
            <AlertCircle className="h-4 w-4 mt-0.5 shrink-0" />
            Gagal masuk dengan akun eksternal. Silakan coba lagi.
          </div>
        )}

        {error === "OAuthNotConfigured" && (
          <div className="mb-6 p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/20 flex items-start gap-2 text-sm text-yellow-400">
            <AlertCircle className="h-4 w-4 mt-0.5 shrink-0" />
            Masuk dengan akun eksternal belum dikonfigurasi. Hubungi administrator.
          </div>
        )}
